...
<div id="container">
	...
	<div id="subtitleArea">
        ...
        <div id="tbody">
        <div id="modify">
            <form action="/modify" method="post" onsubmit="return validatePassword()">
                <div class="form-row">
                    <label>아이디</label>
                ...
                <div class="form-row">
                    ...
                    <input type="password" name="confirmNewPassword" placeholder="새 비밀번호를 재입력해주세요" required>
                    <p class="error-message" id="passwordMismatchMessage" style="display:none;">비밀번호가 일치하지 않습니다.</p>
                </div>

                <div class="form-row">
                    <label>휴대폰 번호</label>
                    <div class="phone-input-wrapper">
                        <input type="text" name="phone" value="${member.phone}" placeholder="010-1111-2222" pattern="010-[0-9]{4}-[0-9]{4}" required>
                    </div>
                </div>
